...
public class ThreadHeaderService extends BaseCoreService<ThreadHeader> {
	...
	public SearchQuery<ThreadHeaderData> findAllByUserId(String query, Integer startPage, Integer maxPage)
			throws Exception {
	...
	public SearchQuery<ThreadHeaderData> findAllByUserLike(String query, Integer startPage, Integer maxPage)
			throws Exception {
	...
	public SearchQuery<ThreadHeaderData> findAllByUserBookmark(String query, Integer startPage, Integer maxPage)
			throws Exception {
	...
	public SearchQuery<ThreadHeaderData> findAllDesc(String query, Integer startPage, Integer maxPage) throws Exception {
		List<ThreadHeader> dataDb = threadHdrDao.findAllDesc(query, startPage, maxPage);
