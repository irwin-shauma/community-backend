...
public class EventPaymentHistoryDao extends AbstractJpaDao<EventPaymentHistory> {
	...
	public List<EventPaymentHistory> findAllUnapprove(String query, Integer startPage, Integer maxPage)
			throws Exception {
	...
	public List<EventPaymentHistory> findAllByUser(String user, String query, Integer startPage, Integer maxPage)
			throws Exception {
	...
	public Long countAllUnapprove() throws Exception {
		StringBuilder sqlBuilder = new StringBuilder()
				.append("SELECT COUNT(eph.id) FROM event_payment_history eph INNER JOIN payment p ")
				.append("ON eph.payment_id = p.id WHERE p.is_approve = false");
